...
# peso=int(input("cual es el peso del producto en gramos: "))
# while peso<1:
#     print("iNGRESE SOLO NUMEROS POSITIVOS")
#     peso=int(input("cual es el peso del producto en gramos: "))
# sodio=float(input("que porcentaje de sodio tiene el producto: "))
# while sodio<1 or sodio>100:
#     print("INGRESE UN PORCENTAJE VALIDO")
#     sodio=float(input("que porcentaje de sodio tiene el producto: "))
# mercado=int(input("Ingres 1 si desea envio nacional o 2 para envio enternacional: "))
# while 0>mercado<3:
...
#     sticker=""
# else:
#     sticker="sello para envio internacional sanitario"
